...
namespace Neptuno2022EF.Datos.Repositorios
{
    public class RepositorioProductos : IRepositorioProductos
    {
        ...
        public List<ProductoListDto> Filtrar(Func<Producto, bool> predicado, int cantidad, int pagina)
        {
            return _context.Productos.Include(p => p.Categoria)
                ...
                .Select(p => new ProductoListDto
                {
                    ...
                    UnidadesDisponibles = p.UnidadesEnPedido,
        ...
        {
            return _context.Productos.Include(c => c.Categoria)
